        ...
        for (let r = 0; r < board.length; r++) {
            for (let c = 0; c < board[r].length; c++) {
                ...
                if (
                    ...
                    (squares.get(squarePlace) && squares.get(squarePlace).has(board[r][c]))
                ) {
                    return false;
                }
                ...
                if (!squares.has(squarePlace)) squares.set(squarePlace, new Set());

                rows.get(r).add(board[r][c]);
                columns.get(c).add(board[r][c]);
                squares.get(squarePlace).add(board[r][c]);
            }
        }
